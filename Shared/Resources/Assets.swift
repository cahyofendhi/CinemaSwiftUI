...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let onboard4 = ImageAsset(name: "onboard_4")
  }
  internal enum Colors {
    internal static let appBlack = ColorAsset(name: "app_black")
    internal static let appBlue = ColorAsset(name: "app_blue")
    internal static let appGray = ColorAsset(name: "app_gray")
  }
}
